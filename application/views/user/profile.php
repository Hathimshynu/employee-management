...
<body>
    ...
    <div class="container mt-5 md-8 sm-6 lg-9">
                            ...
                            <div class="card-body">
                                <div class="live-preview">
                                    <div class="row gy-4">
                                        ...
                                        <div class="col-6">
                                            <div>
                                                <label for="placeholderInput" class="form-label">Nationality </label>
                                                <input type="text" class="form-control" value="<?= $profile['nationality'] ?>" name="nationality" id="nationality">
                                            </div>
                                        </div>
                                        <div id='errorDiv'></div>
                                    </div>
